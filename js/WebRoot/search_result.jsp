...
<head>
   ...
   <link href="${basePath}/style/jquery-ui-autocomplete.css" rel="stylesheet" type="text/css" />
	<script data-main="${basePath }/js/uzj/search_result.js" src="${basePath }/js/lib/require.js"></script>
	<script>
		config = {
...
<%--                <div class="area" id="area" style="display:none; right:2%; margin-left:0;">
	            ...
	            <!--全部-->
	            <jsp:include page="search_result/search_result_all.jsp" />
	            <jsp:include page="search_result/search_result_company.jsp" />
	            <jsp:include page="search_result/search_result_address.jsp" />
				<jsp:include page="search_result/search_result_person.jsp" />	   
				<jsp:include page="search_result/search_result_employee.jsp"/>   
				<jsp:include page="search_result/search_result_scope.jsp"/>  
