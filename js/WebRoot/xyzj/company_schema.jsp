...
<head>
	...
	<link href="${basePath}/xyzj/style/style.src.css" rel="stylesheet" type="text/css" />
	<link href="${basePath}/xyzj/style/style.css" rel="stylesheet" type="text/css" />
	<link href="${basePath}/xyzj/style/jquery.mCustomScrollbar.min.css" rel="stylesheet" type="text/css" />
	<script data-main="${basePath }/xyzj/js/combination.js" src="${basePath }/xyzj/js/lib/require.js"></script>
