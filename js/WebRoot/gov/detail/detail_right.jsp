...
<div class="zsEwm zsRight_bottom">
    <img src="${basePath}/gov/favicon.ico" style="display:none" id="codeLogo" alt=""/>
...
<div class="zsRight_block zsRight_a1">
 ...
 <img style="margin: 19px 13px;" src="${basePath }/images/new/tupu.png" >
    ...
    <a href="${basePath}/gov/company/schema/list?s=${bizCompany.companyNo}" class=" zs_newb" target="_blank">发现企业间的隐藏关系</a>
</div>
