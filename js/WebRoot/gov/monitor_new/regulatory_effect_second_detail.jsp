...
<head>
    ...
    <script type="text/javascript" src="${basePath }/gov/js/lib/require.js"></script>
            ...
            <div class="govAudit_main">
                ...
                <div class="govAudit_list">
                    ...
                    <div class="govAudit_body">
                        <div class="govAudit_xs_tit">
                            <p>线索来源：<span>${platformCaseInfo.clueTypeShow}</span></p>
                            <p>线索类型：<span>${platformCaseInfo.clueTypeShow}</span></p>
                ...
                <div class="govAudit_list">
                    ...
                    <div class="govAudit_body govAudit_br">
                        ...
                        <div class="govAudit_body_w1 govAudit_width07">
                            <span>处理方式：</span>
                            <em>${platformCaseInfo.clueProcessTypeShow }</em>
                        </div>
                        <div class="govAudit_body_w1 govAudit_width08">
                            <span> 处理人：</span>
                            <em>${platformCaseInfo.adminName }</em>
                        </div>
                        <div class="govAudit_body_w1 govAudit_width09">
                            <span>处理时间：</span>
                            <em><fmt:formatDate value="${platformCaseInfo.clueVerifyTime }" pattern="yyyy-MM-dd"/> </em>
                        </div>
                        <div class="govAudit_body_w1 govAudit_width10">
                            <span>处理记录：</span>
                            <em>${platformCaseInfo.clueVerifyHistory }</em>
                        </div>
                    </div>
                </div>
                <div class="govAudit_list">
