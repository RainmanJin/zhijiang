...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: basePath + '/images/comment/stars.jpg',
		imageAll : basePath + '/images/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	//显示结果区域
	var result= jQuery('<div class="rater-star-result" style="float:left;height:30px;"></div>');
	...
	content.find('.rater-star-item').mouseover(function() {
		...
		current_value	= settings.min + (current_number - 1) * settings.step;
		...
		$(".commentLevel").val(current_value);
	});
	...
	info_format	: function(value) {
		...
		switch (value) {
			...
			case 2 : 
				...
				break;
			case 3 : 
				info	= '<div class="info-box">3分,&nbsp;一般<div>一般。</div></div>';
				break;
			case 4 : 
