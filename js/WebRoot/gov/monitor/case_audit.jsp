            ...
            <div class="content-infor">
                ...
                <div class="main">
                    ...
                    <div class="clue clue-bottom">
                        ...
                        <h4>处理记录：<textarea name="caseVerifyHistory" cols="" rows=""></textarea></h4>
                        <h4><button  id="caseAuditFormBtn" type="button">提交</button></h4>
                        </form>
                    </div>
                </div>
            </div>
