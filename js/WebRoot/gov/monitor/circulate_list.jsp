...
<head>
    ...
    <script data-main="${basePath }/gov/js/monitor/circulate_list.js" src="${basePath }/gov/js/lib/require.js"></script>
</head>

<body class="container container-jg" data-attr1="circulate" data-attr="clue">
...
<%--                        <select name="">
                ...
                <table cellpadding="0" cellspacing="0" border="0"  >
                    ...
                    <td class='c1'>{5}</td>
                    <td class='c1'>{6}</td>
                    <td class='c1'><a href='${basePath}/gov/user/company/monitor/detail/list?data_attr=circulate&companyNameDigest={7}'>详情</a></td>
                    </tr>
                    </tbody>
                </table>

                <div class="f-page" config='{name: "companyMonitorTable", url:"${basePath}/gov/user/company/monitor/circulate/ajax/list?cityCode=${cityCode}", nodata:".data-no-tip", isAjax:true}'></div>
            </div>
            <%--      <div class="circ">
                    <p class="mbc_title">
