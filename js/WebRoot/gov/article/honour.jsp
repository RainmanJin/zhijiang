...
<body class="container" id="body" data-attr="news" data-attr1="honour">
<jsp:include page="article_header.jsp"/>
<div class="layout main" data-attr="honour">
    <div class="main-left-g">
        <div class="main-report">
            <div class="policy-title"><h2>守信光荣</h2></div>
            ...
            <c:if test="${!(empty page.content) }">
                ...
                <div class="s-page" config='{name: "news", url:"${basePath }/gov/honour/list?total=${param.total}", nodata:"#nodataNews", npage:${empty param.npage ? '1' : param.npage}, spage:${page.totalPages }, total:${page.total }, pin:2, isAjax:false, autoLoad:false}'></div>
            </c:if>
        </div>
    </div>
    <!--end main-left-->
