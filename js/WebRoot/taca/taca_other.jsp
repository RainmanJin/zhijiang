...
<head>
	...
	<script data-main="${basePath }/js/uzj/taca/taca_other.js" src="${basePath }/js/lib/require.js"></script>
</head>
           ...
           <div class="baseCredit" id="container_id">
               <jsp:include page="/taca/left.jsp" />
				<div class="baseRight">
					...
					<form id="addOtherForm" datatype="json" action="${basePath }/taca/apply/add/other" method="post">
						...
						<div class="bR-line">							
							<div class="bRlevel">
								<textarea placeholder="若有违法记录，请说明" style="height: 90px;" name="userTacaCustomsJudiciary.illegalInfo">${empty tacaCustomsJudiciaries || empty tacaCustomsJudiciaries[0].illegalInfo ?'' : tacaCustomsJudiciaries[0].illegalInfo}</textarea>
							</div>
						</div>
					    <h3 class="baseRight-tit"><span>企业法人信用记录</span></h3>
						<div class="bR-line">
							<div class="bRrecord" style="margin-top: 12px;">
								<p><span>企业名称</span><input type="text" name="userTacaLegalPerson.tacaCompanyName" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].tacaCompanyName ?'' : tacaLegalPersons[0].tacaCompanyName}" style="width: 220px;" /></p>
								<p><span>企业地址</span><input type="text" name="userTacaLegalPerson.companyAddress" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].companyAddress ?'' : tacaLegalPersons[0].companyAddress}" style="width: 220px;" /></p>
							</div>
							<div class="bRrecord">
								<p><span>姓名</span><input type="text" name="userTacaLegalPerson.personName" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].personName ?'' : tacaLegalPersons[0].personName}" style="width: 130px;" /></p>
							...
							<div class="bRrecord">
								<p><span>年龄</span><input type="text" data-attr='number' name="userTacaLegalPerson.personAge" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].personAge ?'' : tacaLegalPersons[0].personAge}"  style="width: 120px;" /></p>
								<p><span>民族</span><input type="text" name="userTacaLegalPerson.famousFamily" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].famousFamily ?'' : tacaLegalPersons[0].famousFamily}" style="width: 120px;" /></p>
							</div>
							<div class="bRrecord">
								<p>
									...
									<select data-attr="position"  name="userTacaLegalPerson.position">
								...
								<p>
									...
									<select data-attr="culturalLevel" name="userTacaLegalPerson.culturalLevel">
										 <option data-attr="" value="">请选择</option>
							...
							<div class="bRrecord">
								<p>
									...
									<select data-attr="politicalStatus" name="userTacaLegalPerson.politicalStatus">
										<option data-attr="" value="">请选择</option>
								...
								<p><span>身份证号</span><input type="text"  name="userTacaLegalPerson.cardNumber" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].cardNumber ?'' : tacaLegalPersons[0].cardNumber}" style="width: 220px;" /></p>
							</div>
							<div class="bRrecord">
								<p><span>办公室电话</span><input type="text" data-attr='number' name="userTacaLegalPerson.officePhone" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].officePhone ?'' : tacaLegalPersons[0].officePhone}" style="width: 220px;" /></p>
								<p><span>手机号码</span><input type="text" data-attr='number'  name="userTacaLegalPerson.phoneNumber" value="${empty tacaLegalPersons || empty tacaLegalPersons[0].phoneNumber ?'' : tacaLegalPersons[0].phoneNumber}" style="width: 220px;" /></p>
							</div>
						...
						<div class="bR-line">
							...
							<div class="bRlevel" style="margin: 10px 0 0;">
								<textarea name="userTacaLegalPerson.honorarySocialDuties">${empty tacaLegalPersons || empty tacaLegalPersons[0].honorarySocialDuties ?'' : tacaLegalPersons[0].honorarySocialDuties}</textarea>
							</div>
						</div>
						<div class="bR-line">
							<h3>个人银行信用情况说明</h3>
							<div class="bRlevel" style="margin: 10px 0 0;">
								<textarea name="userTacaLegalPerson.bankCreditStatement">${empty tacaLegalPersons || empty tacaLegalPersons[0].bankCreditStatement ?'' : tacaLegalPersons[0].bankCreditStatement}</textarea>
							</div>
						</div>
						<div class="bR-button">
