...
<head>
    ...
    <script data-main="${basePath}/js/uzj/taca/audit_detaile.js" src="${basePath }/js/lib/require.js"></script>
 	<script>
      var  activityCfg = activityCfg || {page : 'corporate_govern'};
    </script>
</head>
                ...
                <input type="hidden" id="meetingInstitution" value="${userTacaCorporate.meetingInstitution}"/>
                    <div class="bR-line bR-choose">
                        ...
                        <h4>
                            <i>已建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="baseArchitecture" name="baseArchitecture" value="2" class="" />
                            </label>
                            <i>在建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="baseArchitecture" name="baseArchitecture" value="1" class="" />
                            </label>
                            <i>未建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="baseArchitecture" name="baseArchitecture" value="0" class="" />
                            </label>
                        </h4>
                    </div>
                    <div class="bR-line bR-choose">
                        ...
                        <h4>
                            <i>已建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="meetingInstitution" name="meetingInstitution" value="1" class="" />
                            </label>
                            <i>在建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="meetingInstitution" name="meetingInstitution" value="1" class="" />
                            ...
                            <i>未建</i>
                            <label class="jqWrap">
                                <input type="radio" attr="meetingInstitution" name="meetingInstitution" value="0" class="" />
                            </label>
                        </h4>
                    </div>
                    ...
                    <div class="bR-line">
                        ...
                        <div class="bR-line-right">
                            <i style="margin: 0;">注：⼈员职位包含：总经理、副总经理、总监、董事⻓、党委委员或其他</i>
                            <div id="container_id">
                                <c:choose>
                                    <c:when test="${fn:length(userTacaManagers) == 0}">
                                        <div class="bR-bg bR-bg1 bR-bg2" data-attr="repeat_div">
                                            ...
                                            <p><span>年龄</span><input data-attr='age' style="width: 98px;" name="userTacaManagers[0].age"
                                                ...
                                                <select name="userTacaManagers[0].education" disabled="disabled">
                                            ...
                                            <p><span>分工</span><input style="width: 452px;" type="text"
                                                                     name="userTacaManagers[0].divisionLabor" value="" readonly="readonly"/>
                                            </p>
                                            <p><span style="vertical-align: top;">个人荣誉</span><textarea
                                                    name="userTacaManagers[0].personalHonor" readonly="readonly"></textarea></p>
                                            <p><span
                                                    style="line-height: normal;vertical-align: top;">经营失信及<br>金融失信情况</span><textarea
                                                    name="userTacaManagers[0].operateFinanceUncredit" readonly="readonly"></textarea></p>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach items="${userTacaManagers}" var="utm" varStatus="status">
                                            ...
                                            <div class="bR-bg bR-bg1 bR-bg2" data-attr="repeat_div">
                                                ...
                                                <p><span>姓名</span><input style="width: 98px;"
                                                                         ...
                                                                         type="text" value="${utm.name}" readonly="readonly"/></p>
                                                <p><span>年龄</span><input data-attr='age' style="width: 98px;"
                                                                         name="userTacaManagers[${status.index}].age"
                                                                         type="text" value="${utm.age}" readonly="readonly"/>
                                                    <span style="width: 39px;">学历</span>
                                                    <select data-attr="education${status.index}"
                                                            name="userTacaManagers[${status.index}].education" disabled="disabled">
                                                        <option value="">请选择</option>
                                                        <option value="1">硕士及以上</option>
                                                        <option value="2">本科</option>
                                                        <option value="3">大专</option>
                                                    ...
                                                    <input   name="userTacaManagers[${status.index}].position"
                                                             type="text" value="${utm.position}" readonly="readonly"/>
                                                </p>
                                                <p><span>分工</span><input style="width: 452px;" type="text"
                                                                         name="userTacaManagers[${status.index}].divisionLabor"
                                                                         value="${utm.divisionLabor}" readonly="readonly"/></p>
                                                <p><span style="vertical-align: top;">个人荣誉</span><textarea
                                                        name="userTacaManagers[${status.index}].personalHonor" readonly="readonly">${utm.personalHonor}</textarea>
                                                </p>
                                                <p><span style="line-height: normal;vertical-align: top;">经营失信及<br>金融失信情况</span><textarea
                                                        name="userTacaManagers[${status.index}].operateFinanceUncredit" readonly="readonly">${utm.operateFinanceUncredit}</textarea>
                                                </p>
                                            </div>
                                        </c:forEach>
                                    </c:otherwise>
