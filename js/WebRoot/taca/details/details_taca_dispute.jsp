...
<head>
	...
	<script>
      var  activityCfg = activityCfg || {page : 'dispute'};
    </script>
</head>
				   ...
				   <input type="hidden" id="submitType" value="${sessionScope.user.customData.submitType}"/>
					   <div class="bR-line">
				         <table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t10"><input type="text" name="disputes[0].economicTargetAmount" value="${year_2015_1.economicTargetAmount}" readonly="readonly"/></td>
									<td class="bR-t10"><input type="text" name="disputes[2].economicTargetAmount" value="${year_2016_1.economicTargetAmount}" readonly="readonly"/></td>
								</tr>
								<tr>									
									<td class="bR-t9 bR-t8-bg">处理件数</td>
									<td class="bR-t10"><input type="text" name="disputes[0].economicDealNum" value="${year_2015_1.economicDealNum}" readonly="readonly"/></td>
									<td class="bR-t10"><input type="text" name="disputes[2].economicDealNum" value="${year_2016_1.economicDealNum}" readonly="readonly"/></td>
								</tr>
								<tr>									
									<td class="bR-t9 bR-t8-bg">性质</td>
									<td class="bR-t10">
									    <input type="hidden" id="economicProperty0" value="${year_2015_1.economicProperty}"/>
										<select data-attr="economicProperty0" name="disputes[0].economicProperty" disabled="disabled">
									...
									<td class="bR-t10">
										...
										<select data-attr="economicProperty1" name="disputes[2].economicProperty" disabled="disabled">
										 	<option value="">请选择</option>
										 	<option value="企业纠纷">企业纠纷</option>
										 	<option value="工资拖欠">工资拖欠</option>
										 	<option value="消费者投诉">消费者投诉</option>
								...
								<tr>
									...
									<td class="bR-t9 bR-t8-bg">标的额</td>
									<td class="bR-t10"><input type="text" name="disputes[1].economicTargetAmount" value="${year_2015_2.economicTargetAmount}" readonly="readonly"/></td>
									<td class="bR-t10"><input type="text" name="disputes[3].economicTargetAmount" value="${year_2016_2.economicTargetAmount}" readonly="readonly"/></td>
								</tr>
								<tr>									
									<td class="bR-t9 bR-t8-bg">处理件数</td>
									<td class="bR-t10"><input type="text" name="disputes[1].economicDealNum" value="${year_2015_2.economicDealNum}" readonly="readonly"/></td>
									<td class="bR-t10"><input type="text" name="disputes[3].economicDealNum" value="${year_2016_2.economicDealNum}" readonly="readonly"/></td>
								</tr>
								<tr>									
									<td class="bR-t9 bR-t8-bg">性质</td>
									<td class="bR-t10">
									    <input type="hidden" id="economicProperty2" value="${year_2015_2.economicProperty}"/>
									    <select data-attr="economicProperty2" name="disputes[1].economicProperty" disabled="disabled">
										 	<option value="">请选择</option>
										 	<option value="企业纠纷">企业纠纷</option>
										 	<option value="工资拖欠">工资拖欠</option>
										 	<option value="消费者投诉">消费者投诉</option>
									...
									<td class="bR-t10">
									    ...
									    <select data-attr="economicProperty3" name="disputes[3].economicProperty" disabled="disabled">
										 	<option value="">请选择</option>
										 	<option value="企业纠纷">企业纠纷</option>
										 	<option value="工资拖欠">工资拖欠</option>
										 	<option value="消费者投诉">消费者投诉</option>
				      ...
				      <div class="bR-line bR-choose">
				         <h3 style="margin-top:15px;">企业合同管理情况</h3>
							<div class="bR-bg bR-bg5">
								...
								<p><span class="bR-bg5-s1">合同信用领导小组负责人</span><input type="text" name="performance.leadingGroupManager" value="${empty performances || performances[0].leadingGroupManager ?'' : performances[0].leadingGroupManager}" style="width: 250px;" readonly="readonly"/><span class="bR-bg5-s2">联系电话</span><input name="performance.leadingGroupManagerTel" value="${empty performances || performances[0].leadingGroupManagerTel ?'' : performances[0].leadingGroupManagerTel}" style="width: 250px;" type="text" readonly="readonly"/></p>
								<p><span class="bR-bg5-s1">信用管理部门负责人</span><input type="text" name="performance.creditManager" value="${empty performances || performances[0].creditManager ?'' : performances[0].creditManager}" style="width: 250px;" readonly="readonly"/><span class="bR-bg5-s2">联系电话</span><input name="performance.creditManagerTel" value="${empty performances || performances[0].creditManagerTel ?'' : performances[0].creditManagerTel}" style="width: 250px;" type="text" readonly="readonly"/></p>
							</div>
							<div class="bR-bg bR-bg5">
								<p><span class="bR-bg5-s1">合同管理人员配备情况：</span>									
									...
									<i>人数</i>
									<input type="text" name="performance.equipmentNum" style="width: 150px;margin-left: 10px;" value="${empty performances || performances[0].equipmentNum ?'' : performances[0].equipmentNum }" />
								</p>
				      ...
				      <div class="bR-line">
				         ...
				         <table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top">
								...
								<tr>
									<td class="bR-t11"><input type="text" name="performance.purchaseTotal" value="${empty performances || performances[0].purchaseTotal ?'' : performances[0].purchaseTotal}" readonly="readonly"/></td>
									<td class="bR-t11"><input type="text" name="performance.purchaseGovNum" value="${empty performances || performances[0].purchaseGovNum ?'' : performances[0].purchaseGovNum}" readonly="readonly"/></td>
									<td class="bR-t11"><input type="text" name="performance.disputeTotal" value="${empty performances || performances[0].disputeTotal ?'' : performances[0].disputeTotal}" readonly="readonly"/></td>
									<td class="bR-t11"><input type="text" name="performance.disputeGovNum" value="${empty performances || performances[0].disputeGovNum ?'' : performances[0].disputeGovNum}" readonly="readonly"/></td>
									<td class="bR-t11"><input type="text" name="performance.performanceTotal" value="${empty performances || performances[0].performanceTotal ?'' : performances[0].performanceTotal}" readonly="readonly"/></td>
									<td class="bR-t11"><input type="text" name="performance.performanceGovNum" value="${empty performances || performances[0].performanceGovNum ?'' : performances[0].performanceGovNum}" readonly="readonly"/></td>
								</tr>
							</table>
				      </div>
				      <div class="bR-button">
