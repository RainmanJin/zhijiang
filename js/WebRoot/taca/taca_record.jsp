...
<head>
	...
	<script data-main="${basePath }/js/uzj/taca/taca_record.js" src="${basePath }/js/lib/require.js"></script>
       ...
       <div class="base-write">
           ...
           <div class="baseCredit">
				...
				<div class="baseRight" id="container_id">
					<h3 class="baseRight-tit"><span>工商信用记录(若无请忽略)</span></h3>
					<form id="addRecordForm" action="${basePath }/taca/apply/add/record" method="post">
						...
						<div class="bR-line">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t12"><input type="text"  name="tacaBizRecords[0].name" value="${empty recordMap['1']  ?'' : recordMap['1'].name}"/></td>
									<td class="bR-t13"><input type="text"  name="tacaBizRecords[0].level" value="${empty recordMap['1']  ?'' : recordMap['1'].level}"/></td>
									<td class="bR-t14"><input type="text"  name="tacaBizRecords[0].authOrgan" value="${empty recordMap['1']  ?'' : recordMap['1'].authOrgan}"/></td>
									<td class="bR-t15"><input type="text"  name="tacaBizRecords[0].certificateCode" value="${empty recordMap['1']  ?'' :recordMap['1'].certificateCode}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[0].issuingDate" value="${empty recordMap['1']  ?'' : recordMap['1'].issuingDate}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[0].validDate" value="${empty recordMap['1']  ?'' : recordMap['1'].validDate}" placeholder="无期限"/></td>
								</tr>
							</table>
						</div>
						<div class="bR-line">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t12"><input type="text"  name="tacaBizRecords[1].name" value="${empty recordMap['2']  ?'' : recordMap['2'].name}"/></td>
									<td class="bR-t13"><input type="text"  name="tacaBizRecords[1].level" value="${empty recordMap['2']  ?'' : recordMap['2'].level}"/></td>
									<td class="bR-t14"><input type="text"  name="tacaBizRecords[1].authOrgan" value="${empty recordMap['2']  ?'' : recordMap['2'].authOrgan}"/></td>
									<td class="bR-t15"><input type="text"  name="tacaBizRecords[1].certificateCode" value="${empty recordMap['2']  ?'' : recordMap['2'].certificateCode}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[1].issuingDate" value="${empty recordMap['2']  ?'' : recordMap['2'].issuingDate}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[1].validDate" value="${empty recordMap['2']  ?'' : recordMap['2'].validDate}" placeholder="无期限"/></td>
								</tr>
							</table>
						</div>
						<div class="bR-line">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t12"><input type="text"  name="tacaBizRecords[2].name" value="${empty recordMap['3']  ?'' : recordMap['3'].name}"/></td>
									<td class="bR-t13"><input type="text"  name="tacaBizRecords[2].level" value="${empty recordMap['3']  ?'' : recordMap['3'].level}"/></td>
									<td class="bR-t14"><input type="text"  name="tacaBizRecords[2].authOrgan" value="${empty recordMap['3']  ?'' : recordMap['3'].authOrgan}"/></td>
									<td class="bR-t15"><input type="text"  name="tacaBizRecords[2].certificateCode" value="${empty recordMap['3']  ?'' : recordMap['3'].certificateCode}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[2].issuingDate" value="${empty recordMap['3']  ?'' : recordMap['3'].issuingDate}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[2].validDate" value="${empty recordMap['3']  ?'' : recordMap['3'].validDate}" placeholder="无期限"/></td>
								</tr>
							</table>
						</div>
						<div class="bR-line">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t12"><input type="text"  name="tacaBizRecords[3].name" value="${empty recordMap['4']  ?'' : recordMap['4'].name}"/></td>
									<td class="bR-t13"><input type="text"  name="tacaBizRecords[3].level" value="${empty recordMap['4']  ?'' : recordMap['4'].level}"/></td>
									<td class="bR-t14"><input type="text"  name="tacaBizRecords[3].authOrgan" value="${empty recordMap['4']  ?'' : recordMap['4'].authOrgan}"/></td>
									<td class="bR-t15"><input type="text"  name="tacaBizRecords[3].certificateCode" value="${empty recordMap['4']  ?'' : recordMap['4'].certificateCode}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[3].issuingDate" value="${empty recordMap['4']  ?'' :recordMap['4'].issuingDate}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[3].validDate" value="${empty recordMap['4']  ?'' : recordMap['4'].validDate}" placeholder="无期限"/></td>
								</tr>
							</table>
						</div>
						<div class="bR-line">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
								...
								<tr>
									...
									<td class="bR-t12"><input type="text"  name="tacaBizRecords[4].name" value="${empty recordMap['5']  ?'' : recordMap['5'].name}"/></td>
									<td class="bR-t13"><input type="text"  name="tacaBizRecords[4].level" value="${empty recordMap['5']  ?'' : recordMap['5'].level}"/></td>
									<td class="bR-t14"><input type="text"  name="tacaBizRecords[4].authOrgan" value="${empty recordMap['5']  ?'' : recordMap['5'].authOrgan}"/></td>
									<td class="bR-t15"><input type="text"  name="tacaBizRecords[4].certificateCode" value="${empty recordMap['5']  ?'' : recordMap['5'].certificateCode}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[4].issuingDate" value="${empty recordMap['5'] ?'' : recordMap['5'].issuingDate}"/></td>
									<td class="bR-t16"><input class="date_picker" type="text"  name="tacaBizRecords[4].validDate" value="${empty recordMap['5']  ?'' : recordMap['5'].validDate}" placeholder="无期限"/></td>
								</tr>
							</table>
						</div>
						...
						<div class="bR-line">
							<h3>现有的行业资质等级水平</h3>
							<div class="bRlevel ">
								<textarea name="userTacaBiz.level">${empty tacaBizs || empty tacaBizs[0].level ?'' : tacaBizs[0].level}</textarea>
							</div>
						</div>
						...
						<table cellpadding="0" cellspacing="0" border="0" class="base-tb3 base-tb3-top base-tb3-bot">
							...
							<tr>
								<td class="bR-t11">
								  ...
								  <input type="text" name="tacaComplaints[0].number" data-attr='number' value="${empty dishonestyMap['2015_1']  ?'' : dishonestyMap['2015_1'].number}" />
								</td>
								<td class="bR-t11">
								   ...
								   <input type="text" name="tacaComplaints[1].number" data-attr='number' value="${empty dishonestyMap['2016_1']  ?'' : dishonestyMap['2016_1'].number}" />
								</td>
								<td class="bR-t11">
								   ...
								   <input type="text" name="tacaComplaints[2].number" data-attr='number' value="${empty dishonestyMap['2015_2']  ?'' : dishonestyMap['2015_2'].number}" />
								</td>
								<td class="bR-t11">
								   ...
								   <input type="text" name="tacaComplaints[3].number" data-attr='number' value="${empty dishonestyMap['2016_2']  ?'' : dishonestyMap['2016_2'].number}" />
								</td>
								<td class="bR-t11">
								   ...
								   <input type="text" name="tacaComplaints[4].number" data-attr='number' value="${empty dishonestyMap['2015_3']  ?'' : dishonestyMap['2015_3'].number}" />
								</td>
								<td class="bR-t11">
								   ...
								   <input type="text" name="tacaComplaints[5].number" data-attr='number' value="${empty dishonestyMap['2016_3']  ?'' : dishonestyMap['2016_3'].number}" />
								</td>
							</tr>
						</table>
					</div>
					<div class="bR-line">
						<h3>其它消费者投诉未处理事件</h3>
						<div class="bRlevel">
							<textarea name="userTacaBiz.otherUntreated">${empty tacaBizs || empty tacaBizs[0].otherUntreated ?'' : tacaBizs[0].otherUntreated}</textarea>
						</div>
					</div>
					<div class="bR-button">
