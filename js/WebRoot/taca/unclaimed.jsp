...
<div class="n-layout base">
    <div class="base-warn">
        <img src="../images/base-warn.png">
        <h3>您还没有申请参加评选或审核暂未通过</h3>
        <h4>请先申请参加评选，或等待审核通过后再次尝试</h4>
        <button onclick=" {window.location.href='${basePath}/user/owner/add_init?attr=taca'}">立即申请</button>
        <%--<h5>* 认领后您可在 个人中心-企业管理 查看审核状态</h5>--%>
    </div>
</div>
