...
<%--<link href="${basePath}/style/new/footer.css" rel="stylesheet" type="text/css"/>--%>
    ...
    <%--<script src="http://map.haosou.com/api/js?key=f9de49f9f54ae5fcbcf7"></script>--%>
    <script type="text/javascript" src="${basePath }/gov/js/lib/My97DatePicker/WdatePicker.js"></script>

</head>
<body>
<jsp:include page="/user/top.jsp"/>
<jsp:include page="/top_search.jsp"/>
<jsp:include page="/to_report.jsp"/>
<jsp:include page="/login_pop.jsp" />
<div class="mainStyle" style="width: 1180px;margin:0 auto;">
    <jsp:include page="/detail/detail_top.jsp"/>
    <jsp:include page="/detail/detail_category.jsp"/>

    <!--==end topCompany==-->


<!--==end companyNav==-->
<div class="layout content zs127">
    ...
    <div class="left" id="detail_left_div">
        ...
        <!--企业自述 -->
        <jsp:include page="/detail/company_readme.jsp"/>
        <!--基础信息  -->
        <jsp:include page="/detail/category_base_info.jsp"/>
        <!--经营状况  -->
        <jsp:include page="/detail/category_operation_state.jsp"/>
        <!--风险信息  -->
        <jsp:include page="/detail/category_judicial_proceedings.jsp"/>
        <!--知识产权  -->
        <jsp:include page="/detail/detail_knowledge_right.jsp"/>
        <!--对外投资  -->
        <jsp:include page="/detail/category_out_invest.jsp"/>
        <!--媒体报道  -->
        <jsp:include page="/detail/media_report.jsp"/>
        <!--累计评论  -->
        <jsp:include page="/detail/category_comment_info.jsp"/>
        <!--底部评论  -->
        <div class="tab-block zsBlock_edit zsBlock_pad detail-list" id="comment_info_div" style="display: none;">
            <jsp:include page="/detail/detail_comment.jsp"/>
        </div>
        <!--end detail-list-->
    </div>
    <!--企业信用码、图谱及最近查询 -->
    <div class="right">
        <jsp:include page="/detail/detail_right.jsp"/>
    </div>
...
<script>
    var DetailCfg = DetailCfg || {
            ...
            historyDetailUrl: '${fn:replace(companyDetailUrl, "companyNo", "{0}")}',
