...
<body  data-nav="help_privacy">
    ...
    <div class="n-layout n-help">
        ...
        <div class="help-right-main">
            ...
            <div class="help-where help-privacy">
            	<p>亲爱的用户，您好：</p>
                <p>浙江之江企业征信服务有限公司（以下简称“之江信用”）非常重视您的企业数据和隐私安全。在您仔细阅读、了解并同意本政策之前，请不要向之江信用提交任何企业数据或隐私数据。</p>
                ...
                <p>4. 免责申明；</p>
                <p>5. 本隐私政策的更新；</p>
                <p>本协议阐述之江信用针对个人信息以企业数据的隐私保护策略，但是一个简单的策略无法解决有关数据处理的所有疑虑，因此之江信用可能会另外提供客户产品或服务专用的信息作为本策略的补充，以便在基于特殊目的处理个人信息或企业数据时通知客户，请您在使用之江信用产品或服务时，注意其他形式的此类通知。</p>
            </div>
            ...
            <div class="help-privacy help-pr-te">
                <div class="help-cj-tit help-cj-tit-b">
                    <p><span>本隐私协议的更新</span></p>
                </div>
                <p>之江信用可能会不定期修改、更新本隐私协议。如果在使用用户个人信息政策方面有大幅度修改时，我们会通过电子邮件通知您，确保您访问我们的网站查询本协议为最新更新版本。</p>
                <div class="help-privacy-pl">
                    <p>注：本隐私协议是之江信用服务条款的重要组成部分，如果您不同意接受本协议，请停止访问我们的网站和使用我们的服务，避免不必要的法律纠纷。</p>
                </div>
            </div>
