	...
	Pingan.Event = (function (){
		...
		var initTabs = function (){
            ...
            var locationHref = function () {
                ...
                location.href=basePath+"/search?key="+searchKey+"&searchType="+searchType+"&industryName="+industryName+"&cityCode="+cityCode+"&capitalNumberCode="+capitalNumberCode+"&curCreditType="+curCreditType;
            }
		};
