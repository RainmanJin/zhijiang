...
<div class="detail-list zsBlock_edit zsBlock_pad zs_b1215" style="display: none" id="adminPunishInfo">
    ...
    <div class="d-page" config='{name: "adminpunish", url:"${basePath}/company/adminpunish/list?companyName=${bizCompany.companyName}", nodata:"#nodataChange", npage:1, spage:${adminPunishPage.totalPages }, total:${adminPunishPage.total }, pin:2, isAjax:true, autoLoad:false}'></div>
    </c:if>
</div>
...
<div class="detail-list zsBlock_edit zsBlock_pad zs_b1215" id="credit_and_awards" style="display: none">
    ...
    <div class="tab-block" id="credit_enterpriseInfos_div" style="display: none;">
        ...
        <div class="d-page" config='{name: "credItenterpriseInfo_name", url:"${basePath}/company/credItenterpriseInfo/list?companyNameDigest=${bizCompany.companyNameDigest}", nodata:"#nodataChange", npage:1, spage:${credItenterpriseInfoPage.totalPages }, total:${credItenterpriseInfoPage.total }, pin:2, isAjax:true, autoLoad:false}'></div>
        </c:if>
    ...
    <div class="tab-block zsBlock_edit" id="corp_prod_awards_div" style="display: none;">
        ...
        <div class="change zstab-block">
            ...
            <div class="d-page" config='{name: "corpProdAward_name", url:"${basePath}/company/corpProdAward/list?companyNameDigest=${bizCompany.companyNameDigest}", nodata:"#nodataChange", npage:1, spage:${corpProdAwardPage.totalPages }, total:${corpProdAwardPage.total }, pin:2, isAjax:true, autoLoad:false}'></div>
        </c:if>
