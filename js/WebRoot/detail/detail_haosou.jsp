	...
	<body style="overflow:hidden;">
		...
		<div style="height:50px; line-height:50px;border-bottom:solid 1px #ececec;">
			<div style="width:1200px;margin:0px auto;">
				<label class="sidebar-module"><a href="${fn:replace(companyDetailUrl, 'companyNo', param.s)}" style="font-size:16px; color:#444;" id="companyName"></a></label>
				<label class="col-contact1" style="width:160px;">
					<a class="icon2" href="${fn:replace(companyDetailUrl, 'companyNo', param.s)}">查看公司</a>
