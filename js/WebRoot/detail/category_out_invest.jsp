...
<div class="zsBlock zs_b1215" style="display: none;padding: 0 0 0;" id="outInvestInfo">
    <div class="zsBlock_edit">
        ...
        <c:if test="${not empty outinvestPage && not empty outinvestPage.content }">
                ...
                <div class="zsBlock_list zsBlock_invest" list="5" model>
                    ...
                    <div class="invest_right" >
                           <p class="invest_right_p1">
	                            <a href="{0}"
	                               class="mechanism-link" target="_blank">{1}</a>
            ...
            <div class="d-page" config='{name: "outinvest", url:"${basePath }/company/outinvest/list?companyNameDigest=${bizCompany.companyNameDigest}", npage:1, spage:${outinvestPage.totalPages }, total:${outinvestPage.total }, pin:3, isAjax:true, autoLoad:false}'></div>
        </c:if>
